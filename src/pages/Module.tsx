...
export default function Module() {
  ...
  const markModuleComplete = () => {
    updateProgress({ completed: true, completed_at: new Date().toISOString() });
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Progress
                value={(module.module_order / allModules.length) * 100}
                className="w-24"
              />
            </div>
          </div>
      ...
      <div className="container mx-auto px-6 py-8 max-w-6xl">
        ...
        <Card className="mb-8 gradient-card border-border/50">
          ...
          <CardContent>
            ...
            {!progress?.video_watched && module.video_url && (
              <Button onClick={markVideoWatched} variant="outline" size="sm">
            ...
            <CardContent>
              <div className="space-y-3">
                {module.materials.map((material, index) => {
                  const isDownloaded = progress?.materials_downloaded?.includes(
                    material.title
                  );
                  return (
                    <div
                    ...
                    >
                      ...
                      <Button
                        ...
                        size="sm"
                        onClick={() =>
                          downloadMaterial(material.title, material.url)
                        }
                      >

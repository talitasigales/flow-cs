...
import { CheckCircle, Check, X, ClipboardList, ChevronDown } from 'lucide-react';
          ...
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                ...
                {existingResponse && (
                  <Badge variant="outline" className="gap-1 text-primary border-primary/30 text-xs shrink-0">
            ...
            {exercise.description && !isOpen && (
              <CardDescription className="line-clamp-1 mt-1">{exercise.description}</CardDescription>
            )}
          </CardHeader>
        </CollapsibleTrigger>

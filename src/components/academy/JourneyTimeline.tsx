...
import { CheckCircle, Clock, ExternalLink, MapPin, Play } from 'lucide-react';
...
export function JourneyTimeline({ schedules, videoConferenceUrl, specialist }: JourneyTimelineProps) {
  ...
  const progressPercent = Math.round(((completedCount + (todayIdx >= 0 ? 0.5 : 0)) / schedules.length) * 100);
